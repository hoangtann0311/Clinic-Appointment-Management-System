...
public class EncryptionUtil {
    ...
    /**
     * Giải mã cột email (VARCHAR(100)).
     */
    public static String decryptEmailSql(String columnName) {
        return decryptSql(columnName, "VARCHAR", 100);
    }

    /**
     * Giải mã cột phone (VARCHAR(20)).
     */
    public static String decryptPhoneSql(String columnName) {
        return decryptSql(columnName, "VARCHAR", 20);
    }
    ...
    public static String decryptEmailWhere(String columnName) {
        return decryptWhereEqual(columnName, "VARCHAR", 100);
    }
    ...
    public static String decryptPhoneWhere(String columnName) {
        return decryptWhereEqual(columnName, "VARCHAR", 20);
    }
