    ...
    <div class="col-md-7 col-lg-5">
            ...
            <form action="${pageContext.request.contextPath}/change-password"
                ...
                <div class="mb-3">
                    <label for="oldPassword" class="form-label fw-semibold">
                        <i class="bi bi-unlock me-1"></i>Mật khẩu hiện tại <span class="text-danger">*</span>
                    </label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-unlock"></i></span>
                        <input type="password"
                               class="form-control ${not empty errors.oldPassword ? 'is-invalid' : ''}"
                               id="oldPassword"
                               name="oldPassword"
                               placeholder="Nhập mật khẩu hiện tại"
                               required autofocus>
                        <button class="btn btn-outline-secondary toggle-password" type="button"
                                data-target="oldPassword" tabindex="-1">
                            <i class="bi bi-eye"></i>
                        </button>
        ...
        <div class="text-center mt-3">
            <small class="text-muted">
                ...
                Sau khi đổi mật khẩu, bạn cần dùng mật khẩu mới cho lần đăng nhập sau
            </small>
        </div>
    </div>
</div>
...
<script>
// ============================================================
// Client-side validation cho form đổi mật khẩu
// ============================================================
...
function validateChangePasswordForm() {
    ...
    // ----- Mật khẩu hiện tại -----
    if (oldPassword === '') {
        showFieldError('oldPassword', 'Vui lòng nhập mật khẩu hiện tại.');
        isValid = false;
    }
    ...
    if (newPassword === '') {
        ...
        showFieldError('newPassword', 'Mật khẩu mới không được trùng với mật khẩu hiện tại.');
        isValid = false;
    }
