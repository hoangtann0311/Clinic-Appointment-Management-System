                ...
                <c:choose>
                  <c:when test="${not empty r.result_details}">
                    <div class="p-3 rounded-3 mb-3"
                         style="background:#f8f9fa;border-left:4px solid #be123c;">
                      <div class="d-flex align-items-center mb-2">
                        <i class="bi bi-clipboard2-check text-brand me-2"></i>
                        <strong class="small text-brand">Kết quả xét nghiệm</strong>
