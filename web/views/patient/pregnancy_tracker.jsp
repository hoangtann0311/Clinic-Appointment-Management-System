...
<div class="container py-4">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col">
            <h2 class="fw-bold"><i class="bi bi-heart-pulse-fill text-danger me-2"></i>Theo Dõi Thai Kỳ</h2>
            <p class="text-muted mb-0">Hành trình phát triển của bé yêu qua từng tuần tuổi.</p>
        </div>
    </div>
    ...
    <c:choose>
        ...
        <c:when test="${empty pregnancy}">
            <div class="card border-0 shadow-sm rounded-4 text-center py-5">
                <div class="card-body">
                    <div class="mx-auto mb-4 bg-light rounded-circle d-flex align-items-center justify-content-center"
                         style="width: 100px; height: 100px; color: #ff85a2;">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            <h5 class="fw-bold mb-3 text-dark"><i class="bi bi-compass me-2 text-primary"></i>Kích Thước Em Bé</h5>
                            <div class="d-flex align-items-center gap-3 bg-light p-3 rounded-3">
                                <div class="fs-1 px-3 py-2 rounded-circle bg-white shadow-sm" id="babyFruitIcon">
                                    🍎
                                </div>
                                <div>
                                    <h6 class="fw-bold mb-1" id="babyFruitTitle">Đang tính toán...</h6>
                                    <p class="text-muted small mb-0" id="babyFruitDesc">Đang tải mô tả phát triển thai nhi...</p>
                                </div>
                            </div>
                            <div class="mt-3">
                                ...
                                <div class="d-flex justify-content-between text-muted small mt-2">
                                    <span>Bắt đầu</span>
                                    <span>Tuần thứ ${currentWeeks}/40</span>
                                    <span>Ngày sinh</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-4">
                            <h5 class="fw-bold mb-3 text-dark">
                                <i class="bi bi-activity text-success me-2"></i>Chỉ Số Sức Khỏe Gần Nhất
                            </h5>
                            
                            <c:choose>
                                <c:when test="${empty timeline}">
                                    <p class="text-muted text-center py-3 mb-0">Chưa có chỉ số sức khỏe nào được ghi nhận.</p>
                                </c:when>
                                <c:otherwise>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 bg-light rounded-3 text-center">
                                                <i class="bi bi-speedometer text-danger fs-4"></i>
                                                <small class="d-block text-muted mt-1">Cân nặng mẹ</small>
                                        ...
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 bg-light rounded-3 text-center">
                                                ...
                                                <small class="d-block text-muted mt-1">Tim thai</small>
                                        ...
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 bg-light rounded-3 text-center">
                                                ...
                                                <small class="d-block text-muted mt-1">Huyết áp</small>
                                        ...
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 bg-light rounded-3 text-center">
                                                ...
                                                <small class="d-block text-muted mt-1">Bề cao tử cung</small>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            <h5 class="fw-bold mb-4 text-dark">
                                <i class="bi bi-bezier2 text-primary me-2"></i>Dòng Thời Gian Lần Khám
                            </h5>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <div class="position-relative ps-3" style="border-left: 2px dashed #dee2e6;">
                                        <c:forEach var="item" items="${timeline}" varStatus="loop">
                                            <div class="mb-4 position-relative">
                                                <%-- Dot mốc --%>
                                                <div class="position-absolute rounded-circle bg-danger border border-white" 
                                                     style="width: 12px; height: 12px; left: -20px; top: 6px;"></div>
                                                
                                                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-1">
                                                    <h6 class="fw-bold text-dark mb-0">
                                                        Lần khám thai lúc ${item.gestational_age_weeks} tuần ${item.gestational_age_days} ngày
                                                    </h6>
                                                    <span class="badge bg-light text-muted border">${item.appointment_date}</span>
                                                </div>
                                                <p class="text-muted small mb-2">Bác sĩ khám: <strong>BS. ${item.doctor_name}</strong></p>
                                                <div class="p-3 bg-light rounded-3">
                                                    <div class="row g-2 small text-muted mb-2">
                                                        <c:if test="${not empty item.weight_kg}">
                                                            <div class="col-sm-6"><i class="bi bi-check-circle-fill text-success me-1"></i>Cân nặng mẹ: ${item.weight_kg} kg</div>
                                                        </c:if>
                                                        <c:if test="${not empty item.fetal_heart_rate}">
                                                            <div class="col-sm-6"><i class="bi bi-check-circle-fill text-success me-1"></i>Nhịp tim thai: ${item.fetal_heart_rate} nhịp/phút</div>
                                                        </c:if>
                                                        <c:if test="${not empty item.blood_pressure}">
                                                            <div class="col-sm-6"><i class="bi bi-check-circle-fill text-success me-1"></i>Huyết áp: ${item.blood_pressure}</div>
                                                        </c:if>
                                                        <c:if test="${not empty item.fundal_height_cm}">
                                                            <div class="col-sm-6"><i class="bi bi-check-circle-fill text-success me-1"></i>Chiều cao tử cung: ${item.fundal_height_cm} cm</div>
                                                        </c:if>
                                                    </div>
                                                    <div class="border-top pt-2">
                                                        <span class="d-block fw-semibold text-dark small mb-1">Chẩn đoán lâm sàng:</span>
                                                        <p class="mb-0 text-muted small">${not empty item.final_diagnosis ? item.final_diagnosis : 'Không có'}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </c:forEach>
