...
<div class="wrapper">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="${pageContext.request.contextPath}/admin/reception/booking" class="menu-item active">
    ...
    <div class="main-content">
        ...
        <div class="page-title-row">
            <div>
                <h3 class="page-title">Đặt Lịch Khám</h3>
                <span class="page-subtitle">Quản lý Tiếp đón &gt; Đặt lịch thủ công</span>
            </div>
        </div>

        <div class="cams-card">
            <div class="cams-card-header">
                <h5 class="cams-card-title"><i class="bi bi-calendar-plus"></i> Tiếp nhận cuộc gọi tổng đài & Tạo lịch hẹn khám (Manual Booking)</h5>
            </div>
