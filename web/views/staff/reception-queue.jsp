...
<div class="wrapper">
    ...
    <main class="admin-main" id="adminMain">
        ...
        <div class="row g-3 mb-4">
            ...
            <%-- 3. Ca khẩn cấp --%>
            <div class="col-xl-4 col-md-6">
                <div class="card kpi-card kpi-patients <c:if test='${activeSos > 0}'>sos-blink</c:if>" style="<c:if test='${activeSos > 0}'>border: 2px solid var(--rose-500) !important;</c:if>">
                    <div class="card-body">
                        <div class="kpi-icon" style="<c:choose><c:when test='${activeSos > 0}'>background: #fee2e2; color: #dc2626;</c:when><c:otherwise>background: #cffafe; color: #0891b2;</c:otherwise></c:choose>">
        ...
        <div class="admin-card mb-4">
            <div class="card-header">
                <h5><i class="bi bi-chat-right-text-fill"></i> Zalo OA Notifications</h5>
            </div>
            <div class="card-body" style="max-height: 280px; overflow-y: auto;">
                <c:forEach var="msg" items="${zaloMsgs}">
                    <div class="zalo-entry">
                        <div class="d-flex justify-content-between font-monospace text-muted mb-1" style="font-size: 10px;">
