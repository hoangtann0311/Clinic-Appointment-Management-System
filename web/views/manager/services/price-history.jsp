...
<head>
    ...
    <title>Lịch Sử Điều Chỉnh Giá — CAMS Manager</title>
    ...
    <style>
        ...
        .svc-link { color: var(--c-primary); font-weight: 600; text-decoration: none; }
        .svc-link:hover { text-decoration: underline; color: var(--pink-700); }
        ...
        .kmi-total { background: linear-gradient(135deg, var(--pink-500), var(--pink-600)); }
...
<main class="admin-main" id="adminMain">
    ...
    <a href="${pageContext.request.contextPath}/manager/services/" class="btn-back mb-3">
        <i class="bi bi-arrow-left"></i> Quay lại Dịch Vụ Y Tế
    </a>

    <div class="page-header">
        <div>
            <h1><i class="bi bi-clock-history me-2" style="color:var(--pink-500);"></i>Lịch Sử Điều Chỉnh Giá</h1>
            <div style="font-size:0.82rem;color:var(--c-muted);margin-top:0.2rem;">
                Toàn bộ lịch sử thay đổi giá của tất cả dịch vụ y tế
            </div>
        </div>
    </div>
    ...
    <div class="kpi-mini-row">
        <div class="kpi-mini">
            <div class="kpi-mini-icon kmi-total"><i class="bi bi-clock-history"></i></div>
            <div>
                <div class="kpi-mini-value">${totalHistory}</div>
                <div class="kpi-mini-label">Tổng lần điều chỉnh</div>
            </div>
        </div>
    </div>
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <i class="bi bi-list-ul me-2"></i>Danh sách điều chỉnh giá
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/manager/services/?action=detail&id=${h.serviceId}"
                                           class="svc-link">
                                            <c:if test="${not empty h.serviceCode}">
                                                <span style="font-size:0.7rem;color:var(--c-muted);">${fn:escapeXml(h.serviceCode)}</span><br>
                                            </c:if>
                                            ${fn:escapeXml(h.serviceName)}
                                        </a>
                                    </td>
                                    <td>
                                        <c:choose>
                            ...
                            <tr>
                                <td colspan="8">
                                    <div style="text-align:center;padding:3rem 1rem;color:var(--c-muted);">
                                        ...
                                        <h6 class="mt-2">Chưa có lịch sử điều chỉnh giá</h6>
                                    </div>
                                </td>
                            </tr>
                        </c:otherwise>
