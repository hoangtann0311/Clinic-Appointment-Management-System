...
javac --release 17 -cp "C:\Program Files\Apache Software Foundation\Tomcat 10.1_Tomcat1_Dev\lib\*;C:\Program Files\Apache Software Foundation\Tomcat 10.1\lib\*;web\WEB-INF\lib\*" -d build\web\WEB-INF\classes -sourcepath src\java -encoding UTF-8 @"%SOURCE_LIST%"
